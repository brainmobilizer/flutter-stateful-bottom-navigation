  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SizedBox.expand(
        child: InkWell(
          onTap: () {
            Navigator.pushNamed(context, "/" + destination.title.toLowerCase() + "-list");
          },
          child: Center(
            child: Text('tap here'),
          ),
          ...
          itemBuilder: (BuildContext context, int index) {
            return SizedBox(
              ...
              child: Card(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.pushNamed(context, "/" + destination.title.toLowerCase() + "-text");
                  },
                  child: Center(
                    child: Text('Item $index', style: Theme.of(context).primaryTextTheme.bodyText1),
                  ),
                ),
              ),
            );
        ...
        return MaterialPageRoute(
          ...
          builder: (BuildContext context) {
            if (settings.name == "/") {
              ...
              if (settings.name.contains("-list")) {
                return ListPage(destination: widget.destination);
              } else if (settings.name.contains("-text")) {
